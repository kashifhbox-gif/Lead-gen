  ...
  return (
    <div className="min-h-full flex flex-col items-center p-4 pt-10 md:pt-20 pb-20">
      ...
      >
        ...
        <motion.div 
          className="bg-[#0b0f19]/80 border border-indigo-500/20 rounded-3xl p-4 md:p-6 backdrop-blur-xl shadow-[0_0_40px_rgba(99,102,241,0.05)] relative overflow-hidden mb-12"
        >
